 ...
 */
export declare function handleServerError(res: Response, error: Error | any): void;
/**
 ...
 */
export declare function morganMiddleware(res: Response, req: Request, next: NextFunction): void;
